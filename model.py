...
with open('input_old.txt', 'r', encoding = 'utf-8') as f:
  text = f.read()
...
def chat():
    ...
    while True:
        ...
        stop_token = stoi['\n']
        out = m.generate(context, max_new_tokens=100, stop_token=stop_token)[0].tolist()
        
        
        response = decode(out)
        
        
        print("Bot:", response[len(user_input.split()):])
